...
import com.constructora.model.Usuario;
import com.constructora.service.ILoginService;
import com.constructora.service.IResetTokenService;
import com.constructora.util.EmailUtil;
import com.constructora.util.Mail;
	...
	public ResponseEntity<Integer> enviarCorreo(@RequestBody String correo) {
		...
		try {
			...
			if (us != null && us.getIdUsuario() > 0) {
				...
				mail.setSubject("RESTABLECER CONTRASEÑA - CONSTRUCTORA APP");
